...
if($_SESSION['hak_akses']!="Satker"){
    die("<b>Oops!</b> Access Failed.
		<p>Anda Bukan Satker.</p>
		<button type='button' onclick=location.href='index.php'>Back</button>");
}
?>
<!DOCTYPE html>
	...
	<aside class="main-sidebar">
		<section class="sidebar">
			<ul class="sidebar-menu">
				...
				<li class="treeview"><a href="home-satker.php"><i class="fa fa-dashboard"></i> <span>Dashboard</span></i></a></li>
				<li class="treeview"><a href="#"><i class="fa fa-user"></i> <span>Management SPT</span><i class="fa fa-angle-left pull-right"></i></a>
					<ul class="treeview-menu">
						<li><a href="home-satker.php?page=form-input-spt">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-caret-right"></i> Add SPT</a></li>
						<li><a href="home-satker.php?page=form-view-data-spt">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-caret-right"></i> View SPT</a></li>
					</ul>
				</li>
				<li class="treeview"><a href="#"><i class="fa fa-gears"></i> <span>Backup Restore Data</span><i class="fa fa-angle-left pull-right"></i></a>
					<ul class="treeview-menu">
						<li><a href="home-satker.php?page=backup-data">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-download"></i> Backup</a></li>
						<li><a href="home-satker.php?page=restore-data">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-upload"></i> Restore</a></li>
					</ul>
				</li>
			</ul>
		</section>
	...
	<div class="content-wrapper">
		<section class="content">
			<?php
				...
				switch ($page) {
					case 'form-input-spt': include "pages/transaksi/form-input-spt.php"; break;
					case 'delete-data-spt': include "pages/transaksi/delete-data-spt.php"; break;
					case 'form-view-data-spt': include "pages/transaksi/form-view-data-spt.php"; break;
					case 'view-detail-data-spt': include "pages/transaksi/view-detail-data-spt.php"; break;
					case 'input-spt': include "pages/transaksi/input-spt.php"; break;
