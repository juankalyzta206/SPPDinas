		...
		<section class="sidebar">
			<ul class="sidebar-menu">
				...
				<li class="treeview"><a href="#"><i class="fa fa-gears"></i> <span>Backup Restore Data</span><i class="fa fa-angle-left pull-right"></i></a>
					<ul class="treeview-menu">
						<li><a href="home-admin.php?page=backup-data">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-download"></i> Backup</a></li>
						<li><a href="home-admin.php?page=restore-data">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-upload"></i> Restore</a></li>
					</ul>
				</li>
			</ul>
		</section>
