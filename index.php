...
<div class="wrapper">
	<header class="main-header">
		<a href="index.php" class="logo"><span class="logo-mini">SPD</span><span class="logo-lg"><b>SPP</b> DINAS</span></a>
				...
				<ul class="nav navbar-nav">
					<li class="dropdown user user-menu">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown">
							...
							<span class="hidden-xs">Sistem Pengelolaan Data Perjalanan Dinas</span>
						</a>
						<ul class="dropdown-menu">
							<li class="user-header">
								<img src='dist/img/profile/no-image.jpg' class='img-circle' alt='User Image'>
								<p>Sistem Pengelolaan Data Perjalanan Dinas</p>
							</li>
							<li class="user-body">
								<div class="row">
	...
	<footer class="main-footer">
		...
		Copyright &copy; 2020 <a href="#" target="_blank">Lab ICT Budiluhur</a>. All rights reserved
	</footer>
</div>
	<!-- ./wrapper -->
	<!-- jQuery 2.1.4 -->
